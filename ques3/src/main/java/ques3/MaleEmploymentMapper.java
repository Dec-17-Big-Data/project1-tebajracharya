...
public class MaleEmploymentMapper extends Mapper<LongWritable, Text, Text, Text> {
	 ...
	 * values to year 2000 to calculate the male employment percent. The inputs are tested if it is a number or space. 
	 * If it is a space the exception is caught and ignored. Search criteria in the map phase is looking for 
	 * "Employment to population ratio, 15+, male (%) (modeled ILO estimate)" to determine the male employment percentage for 2000 and 2016.
